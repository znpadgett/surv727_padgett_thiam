...
pander(table1 ,caption = "Count of tweets that mentionned candidates pre- and post- debate.")
```

```{r}
panderOptions('table.caption.prefix', 'Table 2: ')
pander(table2 ,caption = "Count of tweets that mentionned candidates in California pre- and post- debate.")
```

```{r}
panderOptions('table.caption.prefix', 'Table 3: ')
pander(table3 ,caption = "Sentiment Analysis average positivity score pre- and post- debate by candidate.")
```
